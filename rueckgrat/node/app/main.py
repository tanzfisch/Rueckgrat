...
from app.utils import ModelRegistry, ChatRequest, ChatResponse, ImageRequest, ImageResponse, LLamaCppInterface, ComfyUIInterface
...
async def lifespan(app: FastAPI):
    ...
    app.state.comfyui = ComfyUIInterface(host, comfyui_port, client_id, "data/images")
...
async def download_file(file_path: str):
    path = Path(f"data/models/{file_path}")
